const TelegramButton = ({url, title}) => {
    return (
    <a href={url}>
        <button
        type="button"
        ...
        class="mb-2 flex flex-col border-blue-400 border-2 rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-blue-400 shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="main-grid-item-icon self-center" fill="none">
