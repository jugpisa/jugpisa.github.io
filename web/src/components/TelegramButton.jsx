const TelegramButton = ({url, title}) => {
    ...
    <a href={url}>
        ...
        class="mb-2 inline-block border-blue-400 border-2 rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-blue-400 shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
